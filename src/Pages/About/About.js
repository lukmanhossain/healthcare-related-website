...
const About = () => {
    return (
        <div id="about">
            ...
            <h6>Our aim Is to provide your's 100% Satisfiction by our Services</h6>
            <div className="mt-5">
                <h3>Our Services</h3>
                <h5>1.Diagnostics</h5>
                <h5>2.Treatment</h5>
